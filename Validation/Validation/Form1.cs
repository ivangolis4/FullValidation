    ...
    public partial class Form1 : Form
    {
        ...
        private void BTNREGISTER_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (valid)
                {
                    using (SqlConnection conn = new SqlConnection("Data Source=DESKTOP-6C1H011\\SQLEXPRESS;Initial Catalog=Users;Integrated Security=True;Encrypt=True;TrustServerCertificate=True"))
                    {
                        conn.Open();
